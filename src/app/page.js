      ...
      <main className="overflow-hidden pb-28 md:pb-32 lg:pb-0">
        <section className="px-4 lg:px-6 pt-4 sm:pt-5 lg:pt-8">
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-[1.12fr_0.88fr] gap-6 items-stretch">
            <article className="relative overflow-hidden rounded-[30px] border border-white/70 bg-white/80 p-5 sm:p-6 lg:p-10 shadow-[0_24px_70px_rgba(26,18,9,0.08)]">
              <div className="absolute -left-16 top-10 h-44 w-44 rounded-full bg-[rgba(166,121,43,0.08)] blur-3xl" />
              <div className="absolute -right-10 bottom-0 h-36 w-36 rounded-full bg-[rgba(26,18,9,0.06)] blur-3xl" />

              <p className="section-pill mb-5 sm:mb-6 text-sm">Ahmedabad wholesale textile sourcing</p>

              <h1 className="font-headings text-4xl sm:text-5xl lg:text-7xl font-bold text-[#1A1209] leading-[0.95] sm:leading-[0.92] tracking-tight max-w-3xl">
                Premium fabrics,
                <br />
              ...
              <p className="mt-5 sm:mt-6 max-w-2xl text-sm lg:text-base leading-7 text-[#6F655B]">
              ...
              <div className="mt-7 flex flex-col sm:flex-row gap-3">
                <a
                  ...
                  className="inline-flex w-full sm:w-auto items-center justify-center gap-2 rounded-full bg-[#1A1209] px-7 py-3.5 text-sm font-semibold text-white shadow-[0_14px_28px_rgba(26,18,9,0.18)] transition-transform duration-200 hover:-translate-y-0.5"
                >
                ...
                <Link
                  href="/catalog"
                  className="inline-flex w-full sm:w-auto items-center justify-center gap-2 rounded-full border border-[#D9D0C2] bg-white/75 px-7 py-3.5 text-sm font-semibold text-[#1A1209] transition-all duration-200 hover:border-[#1A1209] hover:bg-white"
                >
                  View Catalog
                </Link>
              </div>

              <div className="relative mt-6 lg:hidden aspect-[4/3] overflow-hidden rounded-[26px] border border-white/70 shadow-[0_18px_50px_rgba(26,18,9,0.10)]">
                <Image
                  src="/Hero.jpeg"
                ...
                />
                <div className="absolute left-4 top-4 rounded-full border border-white/35 bg-white/15 px-2 py-1.5 text-[10px] uppercase tracking-[0.22em] text-white backdrop-blur-xs">
                  Showroom gallery
                </div>
              </div>
              ...
              <ul className="mt-8 sm:mt-10 grid gap-3 sm:grid-cols-2">
                {businessHighlights.map((item) => (
                  <li key={item} className="flex items-start gap-3 rounded-2xl border border-white/80 bg-white/72 px-4 py-3 text-sm text-[#4C4338] shadow-[0_8px_20px_rgba(26,18,9,0.04)]">
              ...
              <div className="mt-8 sm:mt-10 grid grid-cols-3 gap-3 border-t border-[#E4DBCE] pt-6">
                {[
                  ...
                  <div key={s.l}>
                    <span className="block font-headings text-2xl lg:text-3xl font-bold text-[#1A1209]">{s.n}</span>
                    <span className="mt-1 block text-[11px] uppercase tracking-[0.18em] text-[#7D7366]">{s.l}</span>
                  </div>
                ))}
              </div>
            </article>
            ...
            <aside className="hidden lg:grid gap-6">
              <div className="relative min-h-[240px] sm:min-h-[280px] overflow-hidden rounded-[28px] border border-white/70 shadow-[0_24px_70px_rgba(26,18,9,0.12)]">
                <Image src="/Hero.jpeg" alt="Premium fabric showroom in Ahmedabad" fill priority className="object-cover" />
                <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(26,18,9,0.05)_0%,rgba(26,18,9,0.18)_100%)]" />
                <div className="absolute left-5 top-5 rounded-full border border-white/35 bg-white/15 px-4 py-2 text-[11px] uppercase tracking-[0.22em] text-white backdrop-blur-md">
                  Showroom gallery
                </div>
                <div className="absolute bottom-5 left-5 right-5 rounded-[24px] border border-white/25 bg-[#1A1209]/70 p-4 text-white backdrop-blur-md">
              ...
              <div className="rounded-[28px] border border-white/70 bg-white/78 p-5 sm:p-6 shadow-[0_16px_50px_rgba(26,18,9,0.06)]">
                <p className="section-pill mb-5">Premium brand partnerships</p>
                <div className="grid grid-cols-2 gap-3">
                  {brandNames.map((brand) => (
                    <div
                      key={brand.name}
                      className="flex min-h-[150px] flex-col items-center justify-center gap-3 rounded-2xl border border-[#DDD4C6] bg-[#FBF8F4] p-4 text-center font-semibold text-[#1A1209]"
                    >
                      {brand.img ? (
                        <Image
                          src={brand.img}
        ...
        <section className="px-4 lg:px-6 py-12 sm:py-14 lg:py-20">
          <article className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-[0.82fr_1.18fr] gap-8 items-start">
            <div>
              ...
              <h2 className="font-headings text-3xl sm:text-4xl lg:text-5xl font-bold text-[#1A1209] leading-[1.02] max-w-sm">
                Built for sourcing, not browsing.
              </h2>
              <p className="mt-5 text-sm lg:text-base leading-7 text-[#6F655B] max-w-sm">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              {trustPoints.map((item) => (
                <div key={item.title} className="rounded-[24px] border border-[#DDD4C6] bg-white/88 p-5 sm:p-6 shadow-[0_10px_28px_rgba(26,18,9,0.04)]">
                  <h3 className="font-headings text-xl sm:text-2xl font-bold text-[#1A1209]">{item.title}</h3>
                  <p className="mt-3 text-sm leading-7 text-[#6F655B]">{item.body}</p>
                </div>
              ))}
            </div>
          </article>
        ...
        <section className="px-4 lg:px-6 pb-12 sm:pb-16 lg:pb-20">
          <div className="max-w-7xl mx-auto rounded-[32px] border border-white/70 bg-white/78 p-5 sm:p-6 lg:p-8 shadow-[0_16px_50px_rgba(26,18,9,0.06)]">
            <div className="grid grid-cols-1 lg:grid-cols-[0.9fr_1.1fr] gap-8 items-start">
              <div>
                <p className="section-pill mb-4">Wholesale textile sourcing in Ahmedabad</p>
                <h2 className="font-headings text-3xl sm:text-4xl lg:text-5xl font-bold text-[#1A1209] leading-[1.02] max-w-md">
                  A trusted Ahmedabad textile showroom for wholesale buyers.
                </h2>
              </div>

              <div className="space-y-5 text-sm lg:text-base leading-7 text-[#6F655B]">
                <p>
                ...
                <div className="grid gap-3 sm:grid-cols-2 pt-2">
                  {[
                    ...
                    <div key={item} className="rounded-2xl border border-[#DDD4C6] bg-[#FBF8F4] px-4 py-3 text-sm text-[#4C4338]">
                      {item}
                    </div>
                  ))}
                </div>
        ...
        <section className="px-4 lg:px-6 pb-12 sm:pb-16 lg:pb-20">
          <div className="max-w-7xl mx-auto rounded-[32px] border border-white/70 bg-white/75 p-5 sm:p-6 lg:p-8 shadow-[0_24px_60px_rgba(26,18,9,0.06)]">
            <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-7 sm:mb-8">
              <div>
                ...
                <h2 className="font-headings text-2xl sm:text-3xl lg:text-4xl font-bold text-[#1A1209]">Core collections for wholesale buyers.</h2>
              </div>
              <a href={whatsappLink} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 text-sm font-semibold text-[#1A1209] group">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
              {categoryCards.map((cat) => (
                <Link key={cat.name} href="/catalog" className="group relative overflow-hidden rounded-[24px] min-h-[220px] sm:min-h-[260px] shadow-[0_14px_40px_rgba(26,18,9,0.08)]">
        ...
        <section className="px-4 lg:px-6 pb-12 sm:pb-16 lg:pb-20" id="testimonials">
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-[0.8fr_1.2fr] gap-8 items-start">
            <div>
              ...
              <p className="mt-5 text-sm leading-7 text-[#6F655B] max-w-sm">
            ...
            <div className="grid gap-4 lg:grid-cols-2">
              {testimonials.map((item) => (
                <figure key={item.name} className="rounded-[24px] border border-[#DDD4C6] bg-white/88 p-5 sm:p-6 shadow-[0_10px_28px_rgba(26,18,9,0.04)]">
                  <div className="flex gap-1 text-gold mb-4">
                    {[1, 2, 3, 4, 5].map((star) => <Star key={star} size={14} fill="currentColor" />)}
                  </div>
                  <blockquote className="text-sm leading-7 text-[#4C4338]">“{item.quote}”</blockquote>
                  <figcaption className="mt-5">
                    <span className="block font-semibold text-[#1A1209]">{item.name}</span>
                    <span className="mt-1 block text-xs uppercase tracking-[0.16em] text-[#7D7366]">{item.detail}</span>
                  </figcaption>
                </figure>
              ))}
            </div>
        ...
        <section className="px-4 lg:px-6 pb-12 sm:pb-16 lg:pb-20" id="enquiry">
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-[1fr_0.95fr] gap-6 items-start">
            <div className="rounded-[28px] bg-[#1A1209] p-5 sm:p-6 lg:p-8 text-white shadow-[0_20px_60px_rgba(26,18,9,0.22)]">
            ...
            <div className="rounded-[28px] border border-white/70 bg-white/78 p-5 sm:p-6 lg:p-8 shadow-[0_16px_50px_rgba(26,18,9,0.06)]">
              <p className="section-pill mb-6">FAQs</p>
              <div className="space-y-0">
                {faqs.map((faq) => (
                  <details key={faq.q} className="group border-b border-[#E4DBCE] py-4 cursor-pointer">
                    <summary className="flex items-center justify-between gap-4 text-sm font-semibold text-[#1A1209] list-none">
                      <span>{faq.q}</span>
                      <ChevronRight size={14} className="flex-shrink-0 text-[#7D7366] group-open:rotate-90 transition-transform duration-200" />
                    </summary>
                    <p className="mt-3 text-sm leading-7 text-[#6F655B]">{faq.a}</p>
                  </details>
                ))}
              </div>
            </div>
